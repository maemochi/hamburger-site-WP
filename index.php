<?php get_header(); ?>
    ...
    <main class="l-main-wrapper">
        ...
        <article>
                <ul class="p-branch-menu">
                    <li class="p-branch-menu__content p-branch-menu__content--first">
                        <h2 class="c-title p-branch-menu__title">Take Out</h2>
                        <span class="c-line p-branch-menu__line p-branch-menu__line--first"></span>
                    ...
                    <li class="p-branch-menu__content p-branch-menu__content--second">
                        <h2 class="c-title p-branch-menu__title">Eat In</h2>
        ...
        <section class="p-access">
            ...
            <h2 class="c-title c-title--m p-access__title">見出しが入ります</h2>
